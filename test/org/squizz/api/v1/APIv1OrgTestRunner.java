    ...
    public static void main(String[] args)
    {
        ...
        if(apiOrgSession != null && apiOrgSession.sessionExists()){
            ...
            try{
				...
				//test importing an organisation's own sales order
                System.out.println("Test Importing Organisation Sales Order Record ("+ESDocumentConstants.ESD_VALUE_YES+" or "+ESDocumentConstants.ESD_VALUE_NO+"):");
                testNotify = reader.readLine();
                if(testNotify.equalsIgnoreCase(ESDocumentConstants.ESD_VALUE_YES)){
                    APIv1OrgEndpointTest.testEndpointOrgImportOrderSaleESDocument(testNumber++, apiOrgSession);
                }
