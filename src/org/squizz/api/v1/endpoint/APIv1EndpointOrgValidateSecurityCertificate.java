...
public class APIv1EndpointOrgValidateSecurityCertificate 
{
     ...
     */
    public static APIv1EndpointResponse call(APIv1OrgSession apiOrgSession, int endpointTimeoutMilliseconds, String orgSecurityCertificateID)
    {
        ...
        try{
            ...
            endpointResponse = APIv1HTTPRequest.<APIv1EndpointResponse>sendHTTPRequest(APIv1Constants.HTTP_REQUEST_METHOD_POST, APIv1Constants.API_ORG_ENDPOINT_VALIDATE_CERT+APIv1Constants.API_PATH_SLASH+apiOrgSession.getSessionID(), endpointParams, requestHeaders, requestPostBody, endpointTimeoutMilliseconds, apiOrgSession.getLangBundle(), endpointJSONReader, endpointResponse);
