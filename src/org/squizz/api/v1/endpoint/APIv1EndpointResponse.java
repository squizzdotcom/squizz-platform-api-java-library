...
public class APIv1EndpointResponse extends ESDocument
{
	...
	public static String ENDPOINT_RESULT_CODE_ERROR_ORDER_TEXT_LINES_ONLY_NOT_ALLOWED = "SERVER_ERROR_ORDER_TEXT_LINES_ONLY_NOT_ALLOWED";
	public static String ENDPOINT_RESULT_CODE_ERROR_INVOICE_LINE_NOT_MAPPED = "SERVER_ERROR_INVOICE_LINE_NOT_MAPPED";
	public static String ENDPOINT_RESULT_CODE_ERROR_INVOICE_LINE_TAXCODE_NOT_MAPPED = "SERVER_ERROR_INVOICE_LINE_TAXCODE_NOT_MAPPED";
	public static String ENDPOINT_RESULT_CODE_ERROR_INVOICE_SURCHARGE_NOT_MAPPED = "SERVER_ERROR_INVOICE_SURCHARGE_NOT_MAPPED";
	public static String ENDPOINT_RESULT_CODE_ERROR_INVOICE_SURCHARGE_TAXCODE_NOT_MAPPED = "SERVER_ERROR_INVOICE_SURCHARGE_TAXCODE_NOT_MAPPED";
	public static String ENDPOINT_RESULT_CODE_ERROR_NO_ORG_SUPPLIER_ACCOUNT_ASSIGNED = "SERVER_ERROR_NO_ORG_SUPPLIER_ACCOUNT_ASSIGNED";
	public static String ENDPOINT_RESULT_CODE_ERROR_NO_ORG_SUPPLIER_ACCOUNT_SET = "SERVER_ERROR_NO_ORG_SUPPLIER_ACCOUNT_SET";
