...
public class APIv1LangBundle_en_AU extends ListResourceBundle
{
    ...
    protected Object[][] getContents() {
        return new Object[][] {
            ...
            {APIv1EndpointResponse.ENDPOINT_RESULT_CODE_ERROR_DATA_IMPORT_MISSING_IMPORT_TYPE, "An error occurred when calling SQUIZZ.com's API due to the request not specifying the type of data being imported."},
            ...
            {APIv1EndpointResponse.ENDPOINT_RESULT_CODE_ERROR_ORDER_MAPPED_PRODUCT_PRICE_NOT_FOUND,"An error occurred when calling SQUIZZ.com's API due to not being able to price one or more products in the supplier's organisation."},
